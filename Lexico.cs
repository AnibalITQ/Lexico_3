...
namespace Lexico_3
{
    public class Lexico : Token, IDisposable
    {
        ...
        private int Columna(char t)
        {
            ...
            if (FinArchivo())               return 19;
            else if (t == '\n')             return 25; 
            else if (char.IsWhiteSpace(t))  return 0;
            else if (char.IsLetter(t))      return 1;
            else if (char.IsDigit(t))       return 2;
            else if (t == '.')              return 3;
            else if (t == '=')              return 4;
            else if (t == ':')              return 5;
            else if (t == ';')              return 6;
        ...
        private void Clasifica (int Estado)
        {
            switch (Estado)
            {
                ...
                case 4: setClasificacion(Tipos.Numero); break;
                case 5:  setClasificacion(Tipos.Asignacion); break;
                case 6: 
                case 13:
                case 14: setClasificacion(Tipos.OperadorRelacional); break;
                case 7:
                case 10:
                case 11: 
                case 26: 
                case 27: setClasificacion(Tipos.Caracter); break;
                case 8:  setClasificacion(Tipos.Inicializacion); break;
                case 9:  setClasificacion(Tipos.FinSentencia); break;
                case 12:
                case 15: setClasificacion(Tipos.OperadorLogico); break;
                case 17:
                case 18: setClasificacion(Tipos.OperadorTermino); break;
                case 19: setClasificacion(Tipos.IncrementoTermino); break;
                case 20:
                case 33: setClasificacion(Tipos.OperadorFactor); break;
                case 21: setClasificacion(Tipos.IncrementoFactor); break;
                case 22:
                case 24: setClasificacion(Tipos.Cadena); break;
                case 25: setClasificacion(Tipos.Ternario); break;
                case 31: setClasificacion(Tipos.Inicio); break;
        ...
        public void nextToken()
        {
            ...
            if (getClasificacion() == Tipos.Identificador)
            {
                switch (getContenido())
                {
                    ...
                    case "else": setClasificacion(Tipos.Condicion); break;
